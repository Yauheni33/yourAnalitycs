        ...
        return(
            <section id="about" className="about section">
                <div className="container">
                    ...
                    <p className="intro text-center">Как это работает?</p>
                        <p className="intro text-center" style={{marginTop: "-45px", marginBottom: "200px"}}>Мы собираем комментарии с Ваших видеороликов, анализируем их путем сложных алгоритмов и выдаем полную и понятную статистику по каждому из Ваших видео.
                    </p>
                    <div className="row">
